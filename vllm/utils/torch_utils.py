...
STR_DTYPE_TO_TORCH_DTYPE = {
    ...
    # TurboQuant presets: all use uint8 packed cache format
    "turboquant_k8v4": torch.uint8,
    "turboquant_k8v3": torch.uint8,
    "turboquant_4bit_nc": torch.uint8,
    "turboquant_k4v3_nc": torch.uint8,
    "turboquant_k3v4_nc": torch.uint8,
    "turboquant_3bit_nc": torch.uint8,
    "turboquant_k8v4_rv": torch.uint8,
    "turboquant_k8v3_rv": torch.uint8,
    "turboquant_4bit_nc_rv": torch.uint8,
